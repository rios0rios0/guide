...
- [CHANGELOG Formatting](Documentation-&-Change-Control/CHANGELOG-Formatting.md) -- capitalization and backtick rules for a changelog entry
...
readable without going to the tool. It follows the [YAML conventions](../Code-Style/YAML.md) like
