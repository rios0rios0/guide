...
description: Scaffold a new Go backend project with Clean Architecture, manual constructor DI, and testify. Use when the user asks to create, scaffold, or bootstrap a new Go project.
---
